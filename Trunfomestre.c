...
int main() {
    ...
    printf("Nome da cidade: ");     scanf(" %48[^\n]", cidade_1);
    printf("Populacao: ");          scanf("%lu", &populacao_1);  // ✅ %lu
    ...
    superpoder_1 = (float)populacao_1 + area_1 + pib_1 + pontos_1
                   + densidade_1 + pibpc_1;
    ...
    printf("Nome da cidade: ");     scanf(" %48[^\n]", cidade_2);
    printf("Populacao: ");          scanf("%lu", &populacao_2);  // ✅ %lu
    ...
    superpoder_2 = (float)populacao_2 + area_2 + pib_2 + pontos_2
                   + densidade_2 + pibpc_2;
